...
val unknown_with_subkind :
  ?alloc_mode:Alloc_mode.t -> Flambda_kind.With_subkind.t -> t
...
val this_boxed_float :
  Numeric_types.Float_by_bit_pattern.t -> Alloc_mode.t -> t

val this_boxed_int32 : Numeric_types.Int32.t -> Alloc_mode.t -> t

val this_boxed_int64 : Numeric_types.Int64.t -> Alloc_mode.t -> t

val this_boxed_nativeint : Targetint_32_64.t -> Alloc_mode.t -> t

val these_tagged_immediates : Targetint_31_63.Set.t -> t

val these_boxed_floats :
  Numeric_types.Float_by_bit_pattern.Set.t -> Alloc_mode.t -> t

val these_boxed_int32s :
  Numeric_types.Int32.Set.t -> Alloc_mode.t -> t

val these_boxed_int64s :
  Numeric_types.Int64.Set.t -> Alloc_mode.t -> t

val these_boxed_nativeints :
  Targetint_32_64.Set.t -> Alloc_mode.t -> t
...
type boxed_or_tagged_number = private
  | Boxed of Alloc_mode.t * Flambda_kind.Boxable_number.t * t
  | Tagged_immediate
...
val meet_is_immutable_array :
  Typing_env.t ->
  t ->
  (Flambda_kind.With_subkind.t Or_unknown.t * t * Alloc_mode.t)
  meet_shortcut
