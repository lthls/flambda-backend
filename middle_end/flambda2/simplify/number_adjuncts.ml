...
module type Boxable = sig
  ...
  val this_boxed : Num.t -> Alloc_mode.t -> Flambda2_types.t

  val these_boxed : Num.Set.t -> Alloc_mode.t -> Flambda2_types.t

  val box : Flambda2_types.t -> Alloc_mode.t -> Flambda2_types.t
end
